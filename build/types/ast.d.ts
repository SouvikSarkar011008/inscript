...
export type Statement = VariableDeclaration | FunctionDeclaration | ClassDeclaration | GameDeclaration | AssetDeclaration | BlockStatement | ExpressionStatement | IfStatement | MatchStatement | WhileStatement | ForStatement | LoopStatement | ReturnStatement | BreakStatement | ContinueStatement | EventHandlerDeclaration;
...
export type Expression = Identifier | Literal | BinaryExpression | UnaryExpression | AssignmentExpression | UpdateExpression | CallExpression | MemberExpression | ArrayExpression | ObjectExpression | FunctionExpression | ConditionalExpression | NewExpression | ThisExpression;
...
export type TypeAnnotation = PrimitiveType | ArrayType | FunctionType | UnionType | IdentifierType;
