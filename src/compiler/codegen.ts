...
import { getRuntimeEngineCode } from "../runtime/engine";
import { getCanvasAPICode } from "../runtime/canvas";
import { getInputAPICode } from "../runtime/input";
...
`;
   ...
   * Generate statement
   */
  private generateStatement(stmt: AST.Statement, isExpression: boolean = false): void {
    switch (stmt.type) {
      case "VariableDeclaration":
        this.generateVariableDeclaration(stmt as AST.VariableDeclaration);
        break;
      case "FunctionDeclaration":
        this.generateFunctionDeclaration(stmt as AST.FunctionDeclaration);
        break;
      case "ClassDeclaration":
        this.generateClassDeclaration(stmt as AST.ClassDeclaration);
        break;
      case "GameDeclaration":
        this.generateGameDeclaration(stmt as AST.GameDeclaration);
        break;
      case "AssetDeclaration":
        this.generateAssetDeclaration(stmt as AST.AssetDeclaration);
        break;
      case "BlockStatement":
        this.generateBlockStatement(stmt as AST.BlockStatement);
        break;
      case "ExpressionStatement":
        this.generateExpressionStatement(stmt as AST.ExpressionStatement);
        break;
      case "IfStatement":
        this.generateIfStatement(stmt as AST.IfStatement);
        break;
      case "MatchStatement":
        this.generateMatchStatement(stmt as AST.MatchStatement);
        break;
      case "WhileStatement":
      ...
      case "ForStatement":
        ...
        break;
      case "LoopStatement":
        this.generateLoopStatement(stmt as AST.LoopStatement);
        break;
      case "ReturnStatement":
        this.generateReturnStatement(stmt as AST.ReturnStatement);
        break;
      case "BreakStatement":
        this.emit("break;\n");
        break;
      ...
      case "EventHandlerDeclaration":
        this.generateEventHandler(stmt as AST.EventHandlerDeclaration);
        break;
    }
  }
   ...
   */
  private generateVariableDeclaration(stmt: AST.VariableDeclaration): void {
   ...
   */
  private generateClassDeclaration(stmt: AST.ClassDeclaration): void {
   ...
   */
  private generateGameDeclaration(stmt: AST.GameDeclaration): void {
   ...
   */
  private generateAssetDeclaration(stmt: AST.AssetDeclaration): void {
   ...
   */
  private generateBlockStatement(stmt: AST.BlockStatement): void {
    this.emit("{\n");
    this.indent();
   ...
   */
  private generateExpressionStatement(stmt: AST.ExpressionStatement): void {
    this.emitIndent();
   ...
   */
  private generateLoopStatement(stmt: AST.LoopStatement): void {
   ...
   */
  private generateEventHandler(stmt: AST.EventHandlerDeclaration): void {
  ...
  private generateExpression(expr: AST.Expression): void {
    switch (expr.type) {
      case "Literal":
        this.generateLiteral(expr as AST.Literal);
        break;
      case "Identifier":
        this.emit((expr as AST.Identifier).name);
        break;
      case "BinaryExpression":
        this.generateBinaryExpression(expr as AST.BinaryExpression);
        break;
      case "UnaryExpression":
        this.generateUnaryExpression(expr as AST.UnaryExpression);
        break;
      case "CallExpression":
        this.generateCallExpression(expr as AST.CallExpression);
        break;
      case "MemberExpression":
        this.generateMemberExpression(expr as AST.MemberExpression);
        break;
      case "ArrayExpression":
        this.generateArrayExpression(expr as AST.ArrayExpression);
        break;
      case "ObjectExpression":
        this.generateObjectExpression(expr as AST.ObjectExpression);
        break;
      case "FunctionExpression":
        this.generateFunctionExpression(expr as AST.FunctionExpression);
        break;
      case "NewExpression":
        this.generateNewExpression(expr as AST.NewExpression);
        break;
      case "ConditionalExpression":
        this.generateConditionalExpression(expr as AST.ConditionalExpression);
        break;
      case "ThisExpression":
        this.emit("this");
        break;
   ...
   * Generate literal
   */
  private generateLiteral(expr: AST.Literal): void {
   ...
   */
  private generateBinaryExpression(expr: AST.BinaryExpression): void {
    this.emit("(");
   ...
   */
  private generateUnaryExpression(expr: AST.UnaryExpression): void {
    if (expr.prefix) {
      this.emit(expr.operator);
    }
   ...
   */
  private generateCallExpression(expr: AST.CallExpression): void {
   ...
   */
  private generateMemberExpression(expr: AST.MemberExpression): void {
   ...
   */
  private generateArrayExpression(expr: AST.ArrayExpression): void {
    this.emit("[");
   ...
   */
  private generateObjectExpression(expr: AST.ObjectExpression): void {
    this.emit("{ ");
    for (let i = 0; i < expr.properties.length; i++) {
      if (i > 0) this.emit(", ");
      const prop = expr.properties[i];
      if (prop.key.type === "Identifier") {
        this.emit((prop.key as AST.Identifier).name);
      } else {
   ...
   */
  private generateFunctionExpression(expr: AST.FunctionExpression): void {
    this.emit("function(");
   ...
   */
  private generateNewExpression(expr: AST.NewExpression): void {
    this.emit("new ");
    this.generateExpression(expr.callee);
    this.emit("(");
    for (let i = 0; i < expr.arguments.length; i++) {
   ...
   */
  private generateConditionalExpression(expr: AST.ConditionalExpression): void {
    this.emit("(");
  ...
  private getRuntimeHelpers(): string {
    ...
    const engineCode = getRuntimeEngineCode();
    const canvasCode = getCanvasAPICode();
    const inputCode = getInputAPICode();
